export const getStoreLogo = (storeName: string): string => {
  ...
  if (name.includes('valu-mart') || name.includes('valumart') || name.includes('valuemart')) return '/assets/store_logos/valu-mart.svg';
  ...
  if ((name.includes('giant') && name.includes('tiger')) || name.includes('gianttiger')) return '/assets/store_logos/giant-tiger.svg';
  if (name.includes('iga')) return '/assets/store_logos/iga.svg';
