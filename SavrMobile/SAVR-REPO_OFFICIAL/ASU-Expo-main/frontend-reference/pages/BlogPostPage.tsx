...
const BlogPostPage = () => {
  ...
  const postUrl = `https://savr.app/blog/${post.slug}`;

  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>{`${post.title} - Savr Blog`}</title>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "author": { "@type": "Organization", "name": "Savr" },
          "publisher": {
            "@type": "Organization",
            "name": "Savr",
            "logo": { "@type": "ImageObject", "url": "https://savr.app/assets/savr-logo(primary).svg" }
          },
