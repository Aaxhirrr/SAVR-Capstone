...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col bg-white dark:bg-slate-900 overflow-hidden h-full relative">
      <Helmet>
        <title>Log In - Savr</title>
        <meta name="description" content="Sign in to your Savr account to compare grocery prices and manage your shopping lists." />
        <link rel="canonical" href="https://savr.app/login" />
      </Helmet>
