...
const StoresPage = () => {
  ...
  useEffect(() => {
    storeService.getUserSelectedStores()
      ...
      .catch(_e => console.error('Failed to fetch selected stores'));
  }, []);
  ...
  const handlePriceCheckToggle = async (storeId: string, checked: boolean) => {
    ...
    if (checked) {
      ...
      try {
        ...
        console.error('Failed to add selected store:');
      ...
      try {
        ...
        console.error('Failed to remove selected store:');
  ...
  useEffect(() => {
    const fetchNearbyStores = async () => {
      try {
        ...
        // Get nearby stores from local DB (already filtered to valid brands, sorted by distance)
        ...
        console.error('Error fetching nearby stores:');
