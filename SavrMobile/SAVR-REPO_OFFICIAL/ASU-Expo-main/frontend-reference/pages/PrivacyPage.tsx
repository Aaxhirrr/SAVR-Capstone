...
const PrivacyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-teal-100 via-emerald-100 to-green-100 dark:from-cyan-900 dark:via-teal-900 dark:via-emerald-900 dark:to-green-900">
      <Helmet>
        <title>Privacy Policy - Savr</title>
        <meta name="description" content="Savr's privacy policy. Learn how we collect, use, and protect your personal information." />
        <link rel="canonical" href="https://savr.app/privacy" />
      </Helmet>
      {/* Navigation */}
