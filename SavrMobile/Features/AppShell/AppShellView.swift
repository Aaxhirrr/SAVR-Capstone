...
struct AppShellView: View {
    var body: some View {
        TabView {
            ChatView()
                .tabItem {anola133@en04228526-scai SAVR-Capstone % cd /Users/anola133/Documents/SAVR-Capstone && git add AppShellView.swift && git commit -m "fix: replace custom tab bar with native TabView for proper iOS styling" && git push origin main
                    fatal: pathspec 'AppShellView.swift' did not match any files
                    anola133@en04228526-scai SAVR-Capstone %
